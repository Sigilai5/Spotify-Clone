...
<nav class="navBar">
    ...
    <div class="group">
        ...
        <div class="navItem">
            <a href="profile.php" class="navItemLink">Brian Sigilai</a>
        </div>
